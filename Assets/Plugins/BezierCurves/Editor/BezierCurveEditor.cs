...
public class BezierCurveEditor : Editor
{
    ...
    void DrawPointInspector(BezierPoint point, int index)
    {
        ...
        {
            var other = pointsProp.GetArrayElementAtIndex(index - 1).objectReferenceValue;
        ...
        var newType = (int)((object)EditorGUILayout.EnumPopup("Handle Type", (BezierPoint.HandleStyle)handleStyleProp.enumValueIndex));
    ...
    static void DrawPointSceneGUI(BezierPoint point)
    {
        ...
        if(point.handleStyle != BezierPoint.HandleStyle.None)
        {
            ...
            var newGlobal1 = Handles.FreeMoveHandle(point.globalHandle1, point.transform.rotation,
            ...
            var newGlobal2 = Handles.FreeMoveHandle(point.globalHandle2, point.transform.rotation,
