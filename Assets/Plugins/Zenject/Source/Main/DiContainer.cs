...
namespace Zenject
{
    ...
    public class DiContainer : IInstantiator
    {
        ...
        public FromBinderNonGeneric BindInterfacesTo(Type type)
        {
            ...
            {
                Log.Warning("Called BindInterfacesTo for type {0} but no interfaces were found", type);
            }
