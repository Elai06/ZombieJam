...
namespace ModestTree
{
    public static class Assert
    {
        ...
        public static void Warn(bool condition)
        {
            if (!condition)
            {
                ModestTree.Log.Warning("Warning!  See call stack");
            }
        }
        ...
        public static void Warn(bool condition, Func<string> messageGenerator)
        {
            if (!condition)
            {
                ModestTree.Log.Warning("Warning Assert hit! " + messageGenerator());
            }
        }
        ...
        public static void Warn(bool condition, string message)
        {
            if (!condition)
            {
                ModestTree.Log.Warning("Warning Assert hit! " + message);
            }
        }
